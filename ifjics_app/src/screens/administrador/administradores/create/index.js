...
export default class Create extends Component {
  ...
  createModerador = async () => {
    ...
    if (user) {
      await ApiService.put('/users/administradores/' + user.id)
        .then(() => {
            ...
            <CardItem>
              <Body>
                <Text note>
                  ...
                  Toque no usuário que deseja tornar administrador. O resultado da busca trará apenas os usuários que ainda não são administradores e também não são coordenadores.
                </Text>
              </Body>
            </CardItem>
