...
export default class Administradores extends Component {
  ...
  async refresh() {
    ...
    await ApiService.get('/users/administradores')
  ...
  handleRemove = async () => {
    ...
    await ApiService.delete('/users/administradores/' + data.id)
      .then(() => {
      ...
      <Container>
        ...
        <Content padder>
          ...
          <Card>
            ...
            <CardItem>
              <Body>
                <Text note>
                  Aqui você tem acesso a lista de todos os administradores cadastrados.
                  Você pode remover o papel de administrador de um usuário apenas deletando ele da lista abaixo.
                </Text>
              </Body>
            </CardItem>
          ...
          {!this.state.listViewData.length > 0 ? <Text note style={{ padding: 10 }}>Nenhum administrador encontrado</Text> :
                  ...
                  <Card style={styles.mb}>
                    <CardItem header bordered>
                      <Left>
                        ...
                        <Body>
                          <Text style={{ color: commonColor.primary }}> Administrador</Text>
        ...
        <ActionButton buttonColor={commonColor.secondary}>
          <ActionButton.Item
            ...
            onPress={() => this.props.navigation.navigate('AdministradoresCreate', { onRefresh: this.refresh.bind(this) })}>
