...
export default class Jogos extends Component {
  ...
  async componentDidMount() {
    ...
    if (jogos)
      this.setState({ listViewData: jogos, loaderVisible: false });
    else
      this.refresh();
  }
  ...
  handleDelete = async () => {
    ...
    await ApiService.delete('/jogos/' + data.id)
      .then(() => {
      ...
      <Container>
        ...
        <Content padder>
          ...
          <Card>
            ...
            <CardItem>
              <Body>
                <Text note>
                  Aqui você tem acesso a lista de todos os eventos cadastrados no sistema.
                </Text>
              </Body>
            </CardItem>
          </Card>
            ...
            <List
              ...
              renderLeftHiddenRow={data =>
                <Button
                  ...
                  primary
                  full
                  onPress={() => this.props.navigation.navigate('JogosEdit', { data: data, onRefresh: this.refresh.bind(this) })}
                  style={{
                    flex: 1,
                    alignItems: "center",
                    justifyContent: "center"
                  }}  >
                  <Icon style={{ color: commonColor.tint }} active type='FontAwesome' name="edit" />
                </Button>
              }
        ...
        <ActionButton buttonColor={commonColor.secondary}>
          <ActionButton.Item
            ...
            onPress={() => this.props.navigation.navigate('JogosCreate', { onRefresh: this.refresh.bind(this) })}>
