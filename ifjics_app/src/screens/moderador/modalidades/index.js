...
export default class Modalidades extends Component {
  ...
  async componentDidMount() {
    ...
    var modalidades = await StorageService.getItem('modalidades');

    if (modalidades)
      this.setState({ listViewData: modalidades, loaderVisible: false });
    else
      this.refresh();
  }
  ...
  async refresh() {
    ...
    await ApiService.get('/modalidades')
      .then((response) => { 
        StorageService.setItem('modalidades', response.data);
  ...
  await ApiService.delete('/modalidades/' + data.id)
    .then(() => {
      ...
      <Container>
        ...
        <Content padder>
          ...
          <Card>
            ...
            <CardItem>
              <Body>
                <Text note>
                  Aqui você tem acesso a lista de todas as modalidades esportivas cadastradas no sistema.
                </Text>
              </Body>
            </CardItem>
          </Card>
              ...
              <List
                    ...
                    <Card style={ styles.mb }>
                      <CardItem header bordered>
                        <Left>
                          ...
                          <Body>
                            <Text style={{ color: commonColor.themeColor }}> Modalidade</Text>
                ...
                renderLeftHiddenRow={data =>
                  <Button
                    ...
                    primary
                    full
                    onPress={() => this.props.navigation.navigate('ModalidadeEdit', { data: data, onRefresh: this.refresh.bind(this)}) }
                    style={{
                      flex: 1,
                      alignItems: "center",
        ...
        <ActionButton buttonColor={ commonColor.secondary }>
          <ActionButton.Item
            ...
            onPress={() => this.props.navigation.navigate('ModalidadeCreate', { onRefresh: this.refresh.bind(this)}) }>
