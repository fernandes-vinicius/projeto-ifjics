...
export default class Campi extends Component {
  ...
  handleDelete = async () => {
    ...
    await ApiService.delete('/campi/' + data.id)
      .then(() => {
    ...
    return (
      <Container>
            ...
            <List
              ...
              renderLeftHiddenRow={data =>
                <Button
                  ...
                  primary
                  full
                  onPress={() => this.props.navigation.navigate('CampiEdit', { data: data, onRefresh: this.refresh.bind(this) })}
                  style={{
                    flex: 1,
                    alignItems: "center",
        ...
        <ActionButton buttonColor={commonColor.secondary}>
          <ActionButton.Item
            buttonColor="#1abc9c"
            title="Criar novo campus"
            onPress={() => this.props.navigation.navigate('CampiCreate', { onRefresh: this.refresh.bind(this) })}>
