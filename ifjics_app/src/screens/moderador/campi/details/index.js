        ...
        return (
            <View>
                <Dialog.Container visible={ this.props.visible }>
                    <Dialog.Title>{(data.nome) ? data.nome : 'INDEFINIDO'}</Dialog.Title>
                    <Dialog.Description>Detalhes</Dialog.Description>
                             ...
                             <Card  style={ styles.mb }>
                                ...
                                <CardItem>
                                    <Body>
                                        ...
                                        <Text note>{ (data.localizacao) ? data.localizacao : 'INDEFINIDO'}</Text>
                                    </Body>
                                </CardItem>
                            </Card>
